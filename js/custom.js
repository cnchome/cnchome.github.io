...
if (matchMedia('(min-width: 992px), (max-width: 767px)').matches) {
  function mainNav() {
        ...
        if (top > 70) $('.sticky-navigation').stop().animate({"top": '0'});

       // else $('.sticky-navigation').stop().animate({"top": '-75'});
    }
}
...
if (matchMedia('(min-width: 768px) and (max-width: 991px)').matches) {
  function mainNav() {
       ...
       // else $('.sticky-navigation').stop().animate({"top": '-150'});
    }
}
...
$(document).ready(function () {
    ...
    $("#feedbacks,#top-carousel").owlCarousel({
